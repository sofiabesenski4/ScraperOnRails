...
class WebpagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create webpage" do
    assert_difference("Webpage.count") do
      post webpages_url, params: { webpage: { raw_html: @webpage.raw_html, url: @webpage.url } }
    end
  ...
  test "should update webpage" do
    patch webpage_url(@webpage), params: { webpage: { raw_html: @webpage.raw_html, url: @webpage.url } }
